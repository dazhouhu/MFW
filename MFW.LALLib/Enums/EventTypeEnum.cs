...
namespace MFW.LALLib
{
    public enum EventTypeEnum
    {
        ...
        PLCM_MFW_SIP_REGISTER_UNREGISTERED,         /*3 Unregister client. */
        ...
        PLCM_MFW_SIP_CALL_MODE_CHANGED,             /*32Indicates call mode is changed. */
        PLCM_MFW_SIP_CALL_MODE_UPGRADE_REQ,         /*33Indicates receiving an audio-video call upgrade request. */
        PLCM_MFW_IS_TALKING_STATUS_CHANGED,         /*34*/
        PLCM_MFW_CERTIFICATE_VERIFY,                /*35 Certifate needs user trust.*/
        PLCM_MFW_TRANSCODER_FINISH,                 /*36 transcoding finish*/
        PLCM_MFW_ICE_STATUS_CHANGED,                /*37 Notify ICE status. */
        PLCM_MFW_SUTLITE_INCOMING_CALL,             /*38 Notify SUTLite incoming call. */
        PLCM_MFW_SUTLITE_TERMINATE_CALL,            /*39 Notify SUTLite terminate call. */

        PLCM_MFW_NOT_SUPPORT_VIDEOCODEC,            /*40 Video call is not supported for video codec is not supported. */
        PLCM_MFW_BANDWIDTH_LIMITATION,              /*41 Notify network bandwidth is limitation status. */
        PLCM_MFW_MEDIA_ADDRESS_UPDATED,             /*42 Notify media IP address updated. */
        PLCM_MFW_AUTODISCOVERY_STATUS_CHANGED      /*43 Notify http tunnel auto discovery status changed. */
                                                    //MORE...
    }
}
